...
const routes: Routes = [
  ...
  },
  {
    path: 'categorias',
    children:[
      { path:'',loadChildren: () => import('./categorias/categorias.module').then( m => m.CategoriasPageModule)
  },
  
      { path:'new',loadChildren: () => import('./categorias/nueva-categoria/nueva-categoria.module').then( m => m.NuevaCategoriaPageModule)
    }
   ]
  }
]
